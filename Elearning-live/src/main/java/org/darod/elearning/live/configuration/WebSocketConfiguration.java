package org.darod.elearning.live.configuration;

import org.darod.elearning.live.interceptor.HandshakeInterceptor;
...
public class WebSocketConfiguration implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/live_socket").setAllowedOrigins("*").withSockJS()
                .setHeartbeatTime(60)
                .setClientLibraryUrl("https://cdn.bootcss.com/sockjs-client/1.1.0/sockjs.js")
