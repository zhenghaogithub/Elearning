$(document).ready(function () {
    $.extend({
        ...
        courses_info_item: " <div class=\"courses_info_item item  d-flex p-0  border-bottom justify-content-around\">\n" +
            "                        <img model='courseImgUrl' model_target='src' class=\"course_img\"\n" +
            "                            >\n" +
            ...
            "                                <span>上次学到 : </span>\n" +
            "                                <span model='chapterName' class=\"last_chapter_label\" style=\"color: #b9bbbe;\"></span>\n" +
            "                            </p>\n" +
            "                        </div>\n" +
            ...
            "                            <button href='watchVideo.html' model='lastChapter' model_target='lastChapterId'  id=\"remuse_learn_btn\" class=\"btn btn-primary my-1\" onclick='continue_learn_btn_click(this)'>继续学习</button>\n" +
        ...
        courses_published_item: "<div class=\"courses_published_item item d-flex p-0  border-bottom justify-content-around\">\n" +
            ...
            "                                <span model='firstTag'  class=\"course_label label_first\"></span>\n" +
            "                                <span model='secondTag'  class=\"course_label label_second\"></span>\n" +
            "                                <span model='thirdTag'  class=\"course_label label_third\"></span>\n" +
            "                            </div>\n" +
            ...
            "                                <span>价格 : <span  model='price'  class=\"course_price\"></span></span>\n" +
            "                                <span>学习人数 : <span model='learnNum' class=\"learn_count gray_font_color\"></span></span>\n" +
            ...
            "                                class=\"gray_font_color\"  model='publishTime' ></span></p>\n" +
